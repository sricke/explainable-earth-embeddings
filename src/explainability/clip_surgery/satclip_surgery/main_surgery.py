...
class SatCLIPSurgeryLightningModule(lightning.pytorch.LightningModule):
    """Lightning wrapper around SatCLIPSurgery, mirroring the original SatCLIP module."""
...
def cli_main(default_config_filename="./configs/default.yaml"):
    ...
    cli = MyLightningCLI(
        model_class=SatCLIPSurgeryLightningModule,
    ...
    run_name = f"SatCLIPSurgery_S2_{ts}"
