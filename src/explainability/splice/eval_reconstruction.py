...
DEFAULT_CONCEPT_SET = SPLICE_DIR / "location_text_alignment" / "concept_dictionaries" / "git10m_concept_dictionary.json"
...
def main():
    ...
    p.add_argument("--concept_set", default=str(DEFAULT_CONCEPT_SET), help="Path to concept dictionary JSON")
    ...
    splice_model = build_splice(model, emb_concepts, latlons, args.l1_penalty, args.device)
