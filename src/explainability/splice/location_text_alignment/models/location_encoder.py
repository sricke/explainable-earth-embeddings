...
LOCATION_MODEL_CHECKPOINTS = {
    ...
    "sinr":      str(_SRC_DIR / "location_encoders/sinr/pretrained_models/model_an_full_input_enc_sin_cos_hard_cap_num_per_class_1000.pt"),
}
...
class LocationEncoder(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if self.precomputed:
            ...
            if self.location_model in _LON_FIRST_MODELS or self.location_model.startswith("csp"):
                x = x[:, [1, 0]]
