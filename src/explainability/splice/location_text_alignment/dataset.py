...
class GeoTextDataset(Dataset):
    ...
    Currently supports csv or parquet format, with columns lat, lon, text
    """
    ...
    def __init__(
        ...
        # If split path exists, load this
    ...
    def plot(self, color=None, s=5) -> Figure:
        """
        Plot lat lon points on basemap.
        """
...
def build_dataloaders(
    ...
    """
    Build dataloaders for train and val splits
    """
