from geoclip.geoclip.model import GeoCLIP
from images.clip_surgery.geoclip_surgery.modeling_clip_surgery import CLIPSurgeryVisionTransformer
def get_geoclip(device, surgery: bool = False, return_all: bool = False):
    model = GeoCLIP()
